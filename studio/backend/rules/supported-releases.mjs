...
//   2026-09-23-v3  delivered first, flagged for listening: sub-grid releases
//                  rendered provisionally and Lead promotion without primary
//                  evidence (ACCEPTANCE_CRITERIA "Machine delivery"). Its syntax
//                  and policy values are unchanged from v1. The classification
//                  is the machine-delivery schema `@2`, applied only when the
//                  published Manifest declares it (final/delivery-evaluator.mjs).
export const SUPPORTED_CANONICAL_VERSIONS = Object.freeze(['2026-09-13-v1', '2026-09-23-v2', '2026-09-23-v3']);
