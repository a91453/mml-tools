...
try {
  for(const profile of [
    ...
    try {
      ...
      await runWorkshopChecks({page,base,idle,file,screenshot:name=>page.screenshot({path:fileURLToPath(new URL(`${profile.name}-${name}.png`,out))})});
