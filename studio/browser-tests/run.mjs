...
import { STUDIO_BANK_SCENARIOS, runStudioBankChoiceChecks } from './bank-choices.mjs';
...
try {
  for(const profile of [
    ...
    try {
      ...
      await runStudioBankChoiceChecks({browser,base,profile});
