...
export default {
  ...
  "compat.preserved": "仍有非標準時值，已保留原文，未調整任何時值；可繼續輸出，但瑪奇 Mobile 是否接受尚未實機驗證。",
  "clip.nonstd": "這份譜有 <b>{n} 個非標準時值</b>（瑪奇 PC／MabiIcco 的寫法），<b>瑪奇 Mobile 是否接受尚未實機驗證</b>。原文完整保留了；要換成標準時值按工具列的「還原」。",
  "clip.compressed": "複製時已自動<b>無損壓縮 {n} 字</b>（音樂完全相同）。壓縮只影響送出去的那一份 —— 已經在壓縮模式的軌本來就是壓好的。",
  "fileBox.warn.nonstd": "有 {tracks} 軌共 <b>{n} 個非標準時值</b>（瑪奇 PC／MabiIcco 的寫法），<b>瑪奇 Mobile 是否接受尚未實機驗證</b>。匯入時原文完整保留，之後可用工具列的「還原」換成標準時值。",
  "fileBox.tag.nonstd": "非標準 {n}",
  "fileBox.tag.nonstdTitle": "這一軌有非標準時值，瑪奇 Mobile 是否接受尚未實機驗證。匯入後可用工具列的「還原」換成標準時值 —— 還原會讓字數變多，所以這一列的字數之後還會動。",
  ...
  "roll.hint.playingReadonly": "播放中兩邊唯讀 · 尺上左鍵設開始線、右鍵開選單設結束線，可即時挪動播放範圍",
  ...
  "clip.blocked": "沒有複製：{list}。工作坊寫不出這幾軌的遊戲用文字（遊戲本身接不接受原寫法尚未實機驗證）。",
  "clip.durSnapped": "第 {list} 軌有非標準時值（遊戲是否接受尚未實機驗證），已改成最接近的標準長度（位移 {drift} tick，音符位置有動）。",
  "clip.doubleDotFixed": "第 {list} 軌的雙附點已改寫成等長的寫法（Final 規則不允許 <code>..</code>；遊戲本身是否接受尚未實機驗證）。",
  ...
  "ui.saved": "已暫存",
  "ui.store.broken": "暫存失敗 · 請先保存樂譜",
  "ui.store.failed": "暫存失敗，請先將目前樂譜存到歌曲庫或匯出檔案，再離開此頁。也可以按「重試暫存」重新寫入。",
  "ui.store.retry": "重試暫存",
  "ui.store.recovered": "目前樂譜已重新暫存成功。",
  ...
  "ui.bad.nonstd": "用了非標準時值（遊戲是否接受尚未實機驗證）；複製時保留原文，不調整時值",
  "ui.bad.red": "紅色：{list}",
  ...
  "html.rangeSel.0": "全曲",
  "html.rangeSel.1@title": "設定範圍：小節尺上左鍵設開始、右鍵開選單（選單前兩項就是開始線和結束線）；箭頭工具（0）在捲軸空白處左鍵設開始、右鍵同樣開選單",
  "html.rangeSel.1": "範圍",
  "html.loopBtn@title": "循環播放：播到結尾（或結束線）立刻從頭（或基準線）再播一次",
  "html.loopBtn~0": "循環",
  "html.toolSelect@title": "箭頭（快捷鍵 0）：音符上搬動／改長度／刪除，Shift或Ctrl 點第二個音可以選取整段；空白處左鍵設播放的開始線、右鍵開選單（可設結束線）",
  ...
  "html.rollMode": "編輯中",
  "html.rollTrack": "主旋律",
  "html.rollHint": "左鍵畫 · 拖曳搬動 · 拖右邊框改長度 · 右鍵開選單",
  ...
  "html.paste": "貼上",
  "html.copy": "複製",
  "html.clipBox.0.3": "貼上會取代所有分頁的內容。複製會去掉空白，這裡的字數也不算空白；遊戲本身怎麼算字數尚未實機驗證。",
  "html.fileBox.0.0": "檔案",
  ...
  "pwa.saveFailed": "暫存失敗，已停止重新載入。請先按「重試暫存」或存到歌曲庫；也可先匯出檔案備份。",
