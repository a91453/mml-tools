...
export default {
  ...
  "ui.bankUnparsable": "音色庫無法解析，沒有載入也沒有儲存（{detail}）",
  "ui.bankCheckUnavailable": "無法在這個瀏覽器檢查音色庫，沒有載入也沒有儲存（{detail}）",
  "ui.bankNotBank": "檔案不是 DLS／SoundFont（.dls／.sf2／.sf3）音色庫，沒有載入也沒有儲存",
  "ui.bankTooLarge": "音色庫超過 {mib} MiB 上限，沒有載入也沒有儲存",
  "ui.bankNotKept": "音色庫無法存進這台裝置，沒有載入（{detail}）",
  ...
  "stage.err.bankChanged": "這台裝置保存的音色庫在頁面顯示之後變了；頁面已改為顯示目前保存的音色庫，請再匯出一次。",
